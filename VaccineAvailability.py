...
#Configuration
textNotifications=False #whether to receive sms notifications
...
maxTexts = 10 #The program will run indefinitely until stopped or excepted, but to prevent spam, will only send this many text messages before text functionality is disabled
...
def twilio_notify(body):
    ...
    # textCount += 1
    # if textCount > 10:
        # global textNotifications
        # textNotifications=False
        # print('Turning off text messaging')
